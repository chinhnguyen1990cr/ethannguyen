const CACHE_NAME = 'ren-luyen-cache-v43';
const ASSETS = ['./index.html', './manifest.json', './icon-192.png', './icon-512.png', './nhua.html', './english-grammar.html', './listening-quiz-data.json', './grammar-quiz-data.json', './speaking-practice-data.json', './video-lessons-data.json'];
