const CACHE_NAME = 'ren-luyen-cache-v129';
const ASSETS = ['./index.html', './manifest.json', './pet-sprites.webp', './icon-192.png', './icon-512.png', './icon-maskable-192.png', './icon-maskable-512.png', './nhua.html', './english-grammar.html', './listening-quiz-data.json', './grammar-quiz-data.json', './speaking-practice-data.json', './video-lessons-data.json', './vocab-data.json', './common-sentences-data.json', './dictation-data.json'];
